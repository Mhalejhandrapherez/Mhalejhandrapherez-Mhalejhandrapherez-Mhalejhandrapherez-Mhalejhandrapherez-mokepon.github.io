const sectionReiniciarJuego = document.getElementById('boton-reiniciar')
...
hipodoge.ataques.push(...HOPODOGE_ATAQUES)
...
fetch(`http://192.168.80.11:8080/mokepon/${jugadorId}/posicion`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
